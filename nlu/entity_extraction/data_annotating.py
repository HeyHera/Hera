...
if __name__ == '__main__':
    ...
    kw_list = ['magic', 'in the end', 'memories', 'animals', 'wolves', 'perfect', 'shape of you', 'for you', 'bounce', 'wreaking ball', 'vibes', 'battle symphony', 'grandmaster', 'fifty shades of grey',\
                'revival', 'divide', 'love', '1984', 'she', 'college' 'you']
    kw_list = set(kw_list)
    entity_label = "MUSIC"
